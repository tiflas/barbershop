...
<body>
 ...
 <ul>
  ...
  <section id="menu33">
  <a href="reservas.php"><div class="contenedor12" id="uno"><img class="icono" src="img/1930.png">
  <p class="texto">Barberias</p></a>
  </div>

  <a href="clientesadministrador.php"><div class="contenedor12" id="dos"><img class="icono" src="img/2000px-Group_font_awesome.svg.png">
